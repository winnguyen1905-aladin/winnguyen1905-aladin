...
<!-- Profile Views -->
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=loinguyen1905&base=4264&style=flat-square&color=brightgreen&label=Profile+views" alt="Profile views"/>
</p>
...
<table align="center">
  <tr>
    ...
    <td>
      ...
      <p>
        <img src="https://img.shields.io/badge/Experience-1%2B%20Years-brightgreen?style=flat-square&logo=github" alt="Experience"/>
        <br><br>
        Full-stack engineer crafting <strong>high-throughput</strong>, cloud-native platforms that handle <strong>thousands of users</strong> worldwide.
      </p>
      <br>
      <h3>🏗️ <strong>Architecture</strong></h3>
      <p>
        <img src="https://img.shields.io/badge/Architecture-Microservices-blue?style=flat-square&logo=docker" alt="Architecture"/>
        <br><br>
        Architect of complex <strong>microservice</strong> ecosystems, event-driven pipelines, and <strong>serverless</strong> workloads.
      </p>
    </td>
  </tr>
</table>
...
<div align="center">
  <table>
    <tr>
      ...
      <td align="center" width="96">
        <img src="https://pluralsight2.imgix.net/paths/images/corespring-f9a00f4516.png" alt="Spring" width="48" height="48" />
      ...
      <td align="center" width="96">
        <img src="https://techstack-generator.vercel.app/restapi-icon.svg" alt="Go" width="48" height="48" />
        <br><strong>Go</strong>
      </td>
      <td align="center" width="96">
...
<table>
  <tr>
    <td width="50%">
      <h3>
        <img src="https://media.giphy.com/media/8UHRm5oY4k4FDxq5QG/giphy.gif" width="30" alt="Developer">
        &nbsp;Development
      </h3>
      <p>
        🔧 <strong>Polyglot developer</strong> fluent in <strong>Java, Kotlin, Go, Python, TypeScript, JavaScript,</strong> and even a dash of <strong>C++</strong> for the edge-cases.
      </p>
      <p>
    ...
    <td width="50%">
      <h3>
        <img src="https://media.giphy.com/media/kH1DBkPNyZPOk0BxrM/giphy.gif" width="30" alt="Cloud">
        &nbsp;Cloud & DevOps
      </h3>
      <p>
        ☁️ Building <strong>cloud-native platforms</strong> that handle <strong>thousands of users</strong> with microservices, serverless workloads, and event-driven architectures.
      </p>
      <p>
  ...
  <tr>
    <td width="50%">
      <h3>
        <img src="https://media.giphy.com/media/LnQjpWaON8nhr21vNW/giphy.gif" width="30" alt="Open Source">
        &nbsp;Community
      </h3>
      <p>
        📢 <strong>Passionate about discussing technology</strong>, ready to create great libraries.
      </p>
      <p>
    ...
    <td width="50%">
      <h3>
        <img src="https://media.giphy.com/media/QssGEmpkyEOhBCb7e1/giphy.gif" width="30" alt="Goals">
        &nbsp;2024 Goals
      </h3>
      <p>
        🎯 <strong>2024 roadmap:</strong> release an open-source library, ship a SaaS side-project, and crush my previous LeetCode streak.
      </p>
      <p>
        <img src="https://img.shields.io/badge/LeetCode-FFA116?style=flat-square&logo=leetcode&logoColor=white" alt="LeetCode"/>
        <img src="https://img.shields.io/badge/OSS-Project-brightgreen?style=flat-square&logo=open-source-initiative&logoColor=white" alt="OSS"/>
      </p>
    </td>
  </tr>
</table>
